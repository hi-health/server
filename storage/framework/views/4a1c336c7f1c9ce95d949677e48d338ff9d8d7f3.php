...
<header class="w3-panel w3-center w3-opacity" style="padding:128px 16px">
  ...
  <div class="w3-padding-32">
    ...
    <table align="center" style="width:30%">
      ...
      <?php $__currentLoopData = $PointConsume; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $PointConsumes): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <tbody>
        <tr>
          <td><?php echo e($PointConsumes->point); ?></td>
          <td><?php echo e($PointConsumes->transaction->users_id); ?></td>
          <td><?php echo e($PointConsumes->created_at->format('Y-m-d')); ?></td>
        </tr>
      </tbody>
