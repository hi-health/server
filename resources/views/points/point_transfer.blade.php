  ...
  <div class="w3-padding-32">
    ...
    <table align="left">
      <form action="{{ url('api/point/'.$users_id.'/transfer') }}" method="post">
        ...
        <font face="monospace" size="4">帳號 : </font>
        <input type="text" name="account" class="form-control" placeholder="請輸入您的帳號"><br><br>
        <font face="monospace" size="4">密碼 : </font>
        <input type="text" name="password" class="form-control" placeholder="請輸入您的密碼"><br><br>
