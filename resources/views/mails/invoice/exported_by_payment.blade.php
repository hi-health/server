...
<html lang="zh-Hant-TW">
    ...
    <body>
        <div class="container">
            ...
            <p class="bigger-b center" style="margin-bottom: 20px">NT {{ number_format($invoice->TotalAmt, 0, '', ',') }}</p>
            ...
            <div class="list">
                <p class="price">{{ $invoice->CreateTime }}</p>
                <p class="title">發票日期</p>
                <p class="status"></p>
            </div>

            <div class="list">
                <p class="price">{{ $invoice->InvoiceNumber }}</p>
                <p class="title">發票號碼</p>
                <p class="status"></p>
            </div>

            <div class="list">
                <p class="price">{{ $invoice->RandomNum }}</p>
                <p class="title">發票隨機碼</p>
                <p class="status"></p>
            </div>

            <div class="list">
                <p class="price">NT {{ number_format($invoice->TotalAmt, 0, '', ',') }}</p>
