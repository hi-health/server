...
<html>
	...
	<form action="<?php echo e(url('password/showResetPassword/'.$user_id.'/'.$code)); ?>" method="post" class="w3-container w3-card-4 w3-light-grey w3-margin w3-center">
		...
		<div class="w3-row w3-section">
			...
			<div class="w3-rest">
				<input type="text" name="sms_code" class="w3-input w3-border" placeholder="請輸入驗證碼">
			</div>
		</div>
