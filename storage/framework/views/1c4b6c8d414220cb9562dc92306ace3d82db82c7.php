...
<header class="w3-panel w3-center w3-opacity" style="padding:128px 16px">
  ...
  <div class="w3-padding-32">
    ...
    <table align="center" style="width:30%">
      ...
      <tbody>
        <tr>
          <td><?php echo e($PointProduce_FromUsers->point); ?></td>
          <td><?php echo e($PointProduce_FromUsers->pointconsume_id); ?></td>
          <td><?php echo e($PointProduce_FromUsers->created_at->format('Y-m-d')); ?></td>
        </tr>
      </tbody>
    ...
    <table align="center" style="width:30%">
      ...
      <tbody>
        <tr>
          <td><?php echo e($PointProduce_FromDailys->point); ?></td>
          <td><?php echo e($PointProduce_FromDailys->service_plan_daily_id); ?></td>
          <td><?php echo e($PointProduce_FromDailys->created_at->format('Y-m-d')); ?></td>
        </tr>
      </tbody>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </table>
