    ...
    <div class="form-group">
        <div class="row">
            <div class="col-md-3">
                ...
                <div><?php echo e($user->account); ?></div>
            </div>
            <div class="col-md-3">
                <?php if($user->avatar): ?>
                    <div>
                        <img src="<?php echo e($user->avatar); ?>" width="150" />
                    </div>
                <?php endif; ?>
            </div>
        </div>
            ...
            <div class="col-md-3">
                ...
                <select v-model="form.city_id" id="city" class="form-control" v-on:change="selectCity">
                    <?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($city->id); ?>" data-districts="<?php echo e(json_encode($city->districts)); ?>"><?php echo e($city->name); ?></option>
    ...
    new Vue({
        ...
        data: {
            ...
            form: {
                ...
                online: <?php echo e($user->online); ?>,
                name: '<?php echo e($user->name); ?>',
                male: <?php echo e($user->male); ?>,
                due_at: '<?php echo e($user->doctor->due_at ? $user->doctor->due_at->toDateString():''); ?>',
                birthday: '<?php echo e($user->birthday); ?>',
                city_id: <?php echo e($user->city_id); ?>,
                district_id: <?php echo e($user->district_id); ?>,
                longitude: <?php echo e($user->doctor->longitude); ?>,
                latitude: <?php echo e($user->doctor->latitude); ?>,
                title: '<?php echo e($user->doctor->title); ?>',
                treatment_type: '<?php echo e($user->doctor->treatment_type); ?>',
                experience_year: '<?php echo e($user->doctor->experience_year); ?>',
                education_bonus: <?php echo e($user->doctor->education_bonus); ?>,
                experience: <?php echo json_encode($user->doctor->experience); ?>,
                specialty: <?php echo json_encode($user->doctor->specialty); ?>,
                education: <?php echo json_encode($user->doctor->education); ?>,
                license: <?php echo json_encode($user->doctor->license); ?>,
//                _method: 'PUT'
            },
            messages: {}
        },
        ...
        methods: {
            ...
            submit: function(event) {
                ...
                axios.post('/api/doctors/' + '<?php echo e($user->id); ?>', form_data, {
                    headers: {
                        'content-type': 'multipart/form-data'
                    }
                }).then(function(response) {
                    alert('修改完成');
                    window.location.href = '<?php echo e(route('admin-doctors-list')); ?>';
                })
