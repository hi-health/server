...
<h3>
    ...
    服務管理 - <?php echo e($member->name); ?>的服務列表
</h3>
<hr />
    ...
    <table class="table table-bordered table-striped table-hover">
        ...
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr <?php if( $service->payment_status==3 && strlen($service->invoice)==0): ?>style="color:#F00"<?php endif; ?>>
                    <td><?php echo e($service->order_number); ?></td>
                    <td><?php echo e($service->member->name); ?></td>
                    <td><?php echo e($service->doctor->name); ?></td>
