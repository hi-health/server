        ...
        for ($i=0; $i < $this->session; $i++) { 
            ...
            if($this->testTime[$i]/$this->test_repeat_time < $this->templateTime/5/3){
                ...
                for ($j=0; $j < $this->test_repeat_time; $j++) { 
                    ...
                    $score_1session['goodMove_roll'] += 80 * $isGoodMove[$i][$j]['roll'][0]/count($isGoodMove[$i][$j])/$this->test_repeat_time;
                    $score_1session['goodMove_yaw'] += 80 * $isGoodMove[$i][$j]['yaw'][0]/count($isGoodMove[$i][$j])/$this->test_repeat_time;
                    $score_1session['goodMove_pitch'] += 80 * $isGoodMove[$i][$j]['pitch'][0]/count($isGoodMove[$i][$j])/$this->test_repeat_time;
